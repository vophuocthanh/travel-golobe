      ...
      <div className="mb-[2rem]">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="font-medium text-gray-500 xl:text-md max-sm:text-xs">
          ...
          <div>
            <h2 className="mb-3 font-bold text-red-500 xl:text-3xl">
              {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(
                getBookingFlightDetails?.totalAmount || 0
              )}
            </h2>
            <p className="flex font-medium text-md max-sm:text-sm">
