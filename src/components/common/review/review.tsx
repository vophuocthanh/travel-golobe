...
const slide = [
  ...
  {
    title: "A real sense of community",
    content: 'A real sense of community, nurtured”Really appreciate the help and support from the staff during these tough times. Shoutout to Katie for helping me always, even when I was out of the country. And always available when needed.',
    span: "Thomas",
  ...
  },
  {
    ...
    content: "EDITION, luxury boutique hotel brand affiliated to MARRIOTT, entrusted Various Associates to upgrade the beach club of its first hotel opened in China, known as The Sanya",
    span: "Olga",
    address: "Weave Studios – Kai Tak",
  ...
  {
    title: "Indianz",
    content: "The Pala Band of Mission Indians broke ground, literally, on a $170 million expansion and renovation of its casino in southern California.",
    span: " indianz.com",
