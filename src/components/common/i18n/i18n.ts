...
const resources = {
  en: {
    translation: {
      ...
      busesavailable:'No buses are available for this date and destination.',
      Pleaseenter:'Please enter the departure location, destination, departure date, and return date completely.',
      Minimum:"Minimum price",
      Maximum:"Maximum price",
      EnterDestination:'Enter tour',
      ...
      Coaches:'Coach',
      CoachAll:'Coach All',
      Searchfor:'Search for city or airport',
      Selectticketype:'Select ticket type',
      Tickettype:'Ticket type',
      Flight:'Flight',
      FlightAll:'Flight All',
      Pleaseselect:'Please select a ticket before booking.',
      LocationMap:'Location/Map',
      Viewon:'View on google maps',
      ...
      Nodeparture:'No departure location',
      Selecttransportation: 'Select transportation',
      Transportationss: 'Transportation',
      Notransportation: 'No transportation available',
  ...
  vi: {
    translation: {
      Tours: 'Tour',
      TourAll: 'Tất cả tour',
      EnterDestination:'Nhập tour',
      Nodeparture: 'Không có nơi xuất phát',
      Selecttransportation: 'Chọn phương tiện',
      Transportationss: 'Phương tiện',
      Notransportation: 'Không có phương tiện',
      Selecttour: 'Chọn loại tour',
      Tourtype: 'Loại tour',
      Open: 'Mở',
      Close: 'Đóng',
      Selectdeparture:'Chọn nơi xuất phát',
      Departurelocation:'Nơi xuất phát',
      Star:'sao',
      Hotel: 'Khách sạn',
      HotelAll: 'Tất cả khách sạn',
      Search:'Tìm kiếm',
      Enterhotel:'Nhập khách sạn',
      Location:'Địa điểm',
      Enterdeparture: 'Nhập nơi đi...',
      Enterdestination: 'Nhập nơi đến...',
      From: 'Từ',
      To: 'Đến',
      Depart: 'Khởi hành',
      Return: 'Quay lại',
      Pickadate:'Chọn ngày',
      busesavailable:'Không có chuyến xe vào ngày và điểm đến này.',
      Pleaseenter:'Vui lòng nhập đầy đủ điểm đi, điểm đến, ngày khởi hành và ngày trở về.',
      ...
      TripTime: 'Thời gian chuyến đi',
      Brand: 'Thương hiệu',
      TripTo: 'Chuyến đi đến',
      Coaches: 'Xe khách',
      CoachAll: 'Tất cả xe khách',   
      Searchfor: 'Tìm kiếm thành phố hoặc sân bay',
      Selectticketype: 'Chọn loại vé',
      Tickettype: 'Loại vé',
      Flight: 'Chuyến bay',
      FlightAll: 'Tất cả chuyến bay',
      Pleaseselect:'Vui lòng chọn vé trước khi đặt.',
      LocationMap: 'Vị trí/Bản đồ',
      Viewon: 'Xem trên Google Maps',
