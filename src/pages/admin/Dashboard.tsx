...
export default function Dashboard() {
  ...
  return (
    <div className="w-full p-2">
        ...
        {tabs.map((tab) => (
          <a
            ...
            className={`relative font-medium pb-2 transition-colors duration-300 cursor-pointer ${
              activeTab === tab.name
                ? 'text-teal-600 border-b-2 border-primary'
      ...
      <div className='absolute flex items-cente justify-center right-[3rem] cursor-pointe'>
      ...
      <div className='mt-5'>
        ...
        {stats.map((stat, index) => (
          <div key={index} className="flex flex-col items-center p-4 bg-white rounded-lg shadow w-full h-[6rem] relative">
            <div className='absolute left-[2rem]'>
              <span className="flex text-lg text-gray-500">{stat.label}</span>
