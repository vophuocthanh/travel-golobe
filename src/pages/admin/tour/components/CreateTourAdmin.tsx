      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="w-full p-2 mb-10 space-y-6">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Chọn loại tour</FormLabel>
                <FormControl>
          ...
          <FormField
            ...
            render={({ field }) => {
              const type = watch('type')
              const isDisabled = type === 'open' || Boolean(selectedRoadVehicleId)
              return (
                <FormItem className="flex flex-col">
          ...
          <FormField
            ...
            render={({ field }) => {
              const type = watch('type')
              const isDisabled = type === 'open' || Boolean(selectedFlightId)
              return (
                <FormItem className="flex flex-col">
