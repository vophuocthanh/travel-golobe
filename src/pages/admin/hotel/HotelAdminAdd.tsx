          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="Nhập vị trí khách sạn"
                    {...field}
                    className="border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-300"
                  />
                </FormControl>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    placeholder="Nhập thời gian trả lại"
                    {...field}
                    className="border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-300"
                  />
                </FormControl>
              ...
              <FormItem>
                ...
                <FormControl>
                  <Textarea
                    ...
                    {...field}
                    className="border border-gray-300 rounded-md h-72 focus:outline-none focus:ring focus:ring-blue-300"
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
