...
import { Armchair, Calendar, ChevronRight, CirclePlus, Clock4, CloudUploadIcon, Cpu, CreditCard, DoorOpen, Minus, Plus, SquarePen, X } from 'lucide-react'
...
export default function Account() {
    ...
    const handleDivClick = () => {
        setShowForm(!showForm); // Chuyển trạng thái hiển thị form
    };
                    ...
                    <Tabs defaultValue="account" className="mt-5">
                        ...
                        <TabsContent value="Payment-methods">
                            ...
                            <div className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-4 py-6 my-5 relative gap-6">
                                ...
                                <div className="bg-white text-primary border border-primary border-dashed rounded-2xl shadow-lg w-80 h-44" onClick={handleDivClick}>
                            ...
                            {showForm && (
                                <>
                                    ...
                                    <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 border border-gray-300 rounded-lg shadow-md z-50 w-[640px]">
                                        <X
                                            className="absolute top-2 right-2 text-gray-500 hover:text-gray-800"
                                            onClick={handleCloseForm}
                                        >
                                        </X>
                                        <h2 className="text-xl font-semibold mb-4 text-center">Add a new Card</h2>
                                        <form>
