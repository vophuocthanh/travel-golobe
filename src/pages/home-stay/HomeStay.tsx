import { hotel_istanbul, hotel_istanbul_1 } from '@/assets/images'
import { Footer, Header } from '@/components/common'
import BookingForm from '@/components/common/hotel/booking-form/booking-form'
import { Button } from '@/components/ui/button'
import { Checkbox } from '@/components/ui/checkbox'

import { ChevronDown, ChevronUp, Coffee, Heart, MapPin, Search } from 'lucide-react'
                ...
                <div className='flex flex-col w-full h-full '>
                  ...
                  <div className='w-full h-[25%] flex '>
                    <div className='flex flex-row items-center justify-center w-full gap-4 '>
                      {' '}
                      <Button
                        className={buttonStates.button3 ? 'bg-white border border-primary' : 'bg-primary text-white'}
