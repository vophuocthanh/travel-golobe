                ...
                <div className="container px-4 mx-auto pt-28 pb-36">
                    ...
                    <section className="mb-12">
                        <div className="flex items-center mb-4 space-x-2 text-sm text-gray-600">
                            ...
                            <ChevronRight className="w-4 h-4 text-gray-500" />
                            <p className='overflow-hidden whitespace-pre-line text-ellipsis line-clamp-1 w-[30%]'>{getbyId?.description}</p>
                        </div>
                                ...
                                loading?(
                                    ...
                                    <div className="flex flex-col space-y-6 md:flex-row md:space-y-0 md:space-x-6 ">
                                        <div className="w-full space-y-4 ">
                                            <img src={getbyId?.image_2} alt="Flight" className="object-cover w-full h-[150px] rounded-lg shadow-lg " />
                                            <img src={getbyId?.image_3} alt="Flight" className="object-cover w-full h-[150px] rounded-lg shadow-lg " />
                                            <img src={getbyId?.image_4} alt="Flight" className="object-cover w-full h-[150px] rounded-lg shadow-lg " />
                                            <img src={getbyId?.image_5} alt="Flight" className="object-cover w-full h-[150px] rounded-lg shadow-lg " />
                                        </div>
                                        <img src={getbyId?.image} alt="Tour" className="w-full md:w-[75%] h-auto object-cover rounded-lg shadow-lg" />
                        ...
                        <div className='w-[30%] shadow-2xl h-[420px] sticky top-[10rem] rounded-lg'>
                            <div className='p-5'>
                                <div className='flex items-center justify-between '>
                                    ...
                                    <div><span className='text-2xl font-semibold text-red-500'>7,990,000 đ </span>/ Khách</div>
                                </div>
                                <div className='flex py-4'>
                                    ...
                                    <div className='flex items-center justify-center font-medium text-center text-sky-500'>NNSGN133-079-021024VN-V</div>
                                </div>
                                <div className='flex py-4'>
                                    <div className='mr-2'>
                                        <IconDeparture />
                                    ...
                                    <div className='flex items-center justify-center font-medium text-center text-sky-500'>TP. Hồ Chí Minh</div>
                                </div>
                                <div className='flex py-4'>
                                    <div className='mr-2'>
                                        <IconDepartureDate />
                                    ...
                                    <div className='flex items-center justify-center font-medium text-center text-sky-500'>02-10-2024</div>
                                </div>
                                <div className='flex py-4'>
                                    <div className='mr-2'>
                                        <IconTime />
