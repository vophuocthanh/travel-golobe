...
export const hotelApi = {
  ...
  getAllByPrice(page: number | string, items_per_page: number | string, sort_by_price:string, min_price?:number, max_price?:number): Promise<ListResponse<HotelResponseType>>  {
    const url = '/hotel-crawl/crawl';
