function IconDelete() {
  return (
    <svg width='25' height='24' viewBox='0 0 25 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <path d='M3.625 6H5.625H21.625' stroke='#A30D11' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
      <path
      ...
      />
      <path d='M10.625 11V17' stroke='#A30D11' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
      <path d='M14.625 11V17' stroke='#A30D11' strokeWidth='2' strokeLinecap='round' strokeLinejoin='round' />
    </svg>
  )
}
